...
<?php
	...
	echo '<td style="text-align:center;">  <a href="/Redaktor/Del_News/'.$res['id'].'"><img height="25px;width="30px;" src="/photo/del.png"></a>      <a href="/Redaktor/Corr_News/'.$res['id'].'"><img height="25px;width="30px;" src="/photo/cor.png"></a>                   </td>';
	echo '</tr>';
	}
?>
