...
<?php
	...
	echo '<td style="text-align:center;">  <a href="/Admin/Del_Tyr/'.$res['id'].'"><img height="25px;width="30px;" src="/photo/del.png"></a>      <a href="/Admin/Corr_Tyr/'.$res['id'].'"><img height="25px;width="30px;" src="/photo/cor.png"></a>                   </td>';
	echo '</tr>';
	}
?>
